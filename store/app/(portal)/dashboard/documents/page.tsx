...
export default function DocumentsPage() {
  ...
  return (
    ...
    >
      <div className="mx-auto w-full space-y-4 pb-4 md:space-y-6">
        ...
        >
          ...
          <div className="space-y-3 px-3 pb-4 pt-3 md:hidden">
            ...
            <div className="flex flex-col gap-1 pt-2">
              <div className="flex h-[23px] items-center justify-center gap-1 px-2 text-[13px] font-normal leading-[1.1] text-[#757575]">
                <span>1</span>
                <MinusMini className="size-3.75" />
                <span>10 of 100 results</span>
              </div>
              <div className="flex h-9 items-center gap-2">
                <span className="flex h-7 min-w-0 flex-1 items-center px-2 text-[13px] font-normal leading-[1.1] text-[#757575]">
                  1 of 10 pages
                </span>
                <button
                  type="button"
                  disabled
                  className="flex h-9 items-center justify-center rounded-md px-3 text-sm font-medium leading-[1.1] text-[#a5a5a5]"
                >
                  Prev
                </button>
                <button
                  type="button"
                  className="flex h-9 items-center justify-center rounded-md px-3 text-sm font-medium leading-[1.1] text-[#757575]"
                >
                  Next
                </button>
              </div>
